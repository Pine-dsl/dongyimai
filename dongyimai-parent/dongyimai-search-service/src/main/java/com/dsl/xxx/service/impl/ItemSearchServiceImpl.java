...
//        map.put("rows", page.getContent());
    ...
    private Map searchList(Map searchMap){
        ...
        if(!"".equals(searchMap.get("brand"))){
            ...
            FilterQuery filterQuery2=new SimpleFilterQuery(filterCriteria);
        ...
        if(searchMap.get("spec")!=null){
            ...
            for(String key:specMap.keySet() ){
                ...
                FilterQuery filterQuery3=new SimpleFilterQuery(filterCriteria);
        ...
        if(!"".equals(searchMap.get("price"))) {
            ...
            if (!price[0].equals("0")) {//如果区间起点不等于0
                ...
                FilterQuery filterQuery4 = new SimpleFilterQuery(filterCriteria);
                query.addFilterQuery(filterQuery4);
            }
    ...
    private  List searchCategoryList(Map searchMap){
        ...
        for(GroupEntry<TbItem> entry:content){
            arrayList.add(entry.getGroupValue());//将分组结果的名称封装到返回值中
        }
        return arrayList;
    }
